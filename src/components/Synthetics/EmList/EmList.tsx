  ...
  return (
    <div className="EMList">
                  ...
                  <Tooltip
                    ...
                    renderContent={() => (
                      <p className="text-white">
                        <Trans>Available amount to deposit into the specific EM pool.</Trans>
                      </p>
                    )}
                  />
                </th>
      ...
      {isMobile && (
        <>
          {!hideTitle && (
            <div className="Page-title elp-composition-small title-small">
              <Trans>EM Pools</Trans>
...
function renderMintableAmount({ mintableInfo, market, token, longToken, shortToken }) {
  return (
    <Tooltip
      handle={
        <>
          {formatTokenAmount(mintableInfo?.mintableAmount, token.decimals, "EM", {
            useCommas: true,
            displayDecimals: 0,
          })}
          <br />(
      ...
      renderContent={() => (
        <>
          <p className="text-white">
            <Trans>
              {longToken.symbol} and {shortToken.symbol} can be used to mint EM tokens for this market up to the
